...
class CollectFpnRpnProposalsOp(object):
    ...
    def forward(self, inputs, outputs):
        ...
        if self._train:
            ...
            output_blob_names = roi_data.fast_rcnn.get_fast_rcnn_blob_names_without_mask_blob()
            blobs = {k: [] for k in output_blob_names}
            roi_data.fast_rcnn.add_fast_rcnn_blobs_without_mask_blob(blobs, im_scales, roidb)
